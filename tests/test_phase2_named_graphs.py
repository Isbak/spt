...
def test_named_graph_manifest_loading():
    ...
    assert {record.graph for record in records} >= {"urn:graph:ontology", "urn:graph:provenance", "urn:graph:reasoning", "urn:graph:inferred", "urn:graph:validation", "urn:graph:install-base"}
